...
### Security Audit - 28/5/2020 at 17:39 UTC
-- -
...
| [Arbitrary File Write](https://npmjs.com/advisories/1217) | decompress (dependency) | high | 4.2.0 | <4.2.1 | >=4.2.1 | Upgrade to version 4.2.1 or later. | @theia/plugin-dev>@theia/plugin-ext>decompress |
