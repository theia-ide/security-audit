...
### Security Audit - 13/1/2021 at 19:59 UTC
-- -
...
| [Server-Side Request Forgery](https://npmjs.com/advisories/1594) | axios (dependency) | high | 0.18.1 | <0.21.1 | >=0.21.1 | Upgrade to 0.21.1 or later. | @theia/cli>@theia/application-manager>webpack-cli>yeoman-environment>npm-api>paged-request>axios |
